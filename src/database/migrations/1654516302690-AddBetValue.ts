...
export class AddBetValue1654516302690 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "userBets" ("id" SERIAL , "user_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "expireDays" TIMESTAMP DEFAULT now(), "betValue" integer , "isActive" boolean  DEFAULT true, "advertisement_id" integer, CONSTRAINT "PK_7b72424a093e9be15416ff32467" PRIMARY KEY ("id"))`);
